...
# 產業（category）→（英文 slug, 一句產業概況）。
# 註：原本「其他/其他電子/存託憑證」未列入→該類個股（含鴻海 2317）成為無 hub 入口的孤兒、
#     SEO 內鏈斷裂。為救回可爬入口，已補上對應 hub（intro 誠實說明為混合分類）。
INDUSTRY = {
    "半導體": ("semiconductor", "半導體是台股權值核心，涵蓋晶圓代工、IC 設計、封測、設備與材料，與全球景氣循環及 AI、手機、車用需求高度連動。"),
    "其他電子": ("other-electronics", "其他電子涵蓋未歸入半導體、光電、通信等細分類的電子製造與組裝，個別公司業務差異大，包含鴻海（2317）等大型權值股，請逐檔檢視實際營運。"),
    "其他": ("other", "其他類為未歸入主要產業分類的個股，橫跨多元產業，分類較模糊，建議逐檔檢視公司基本面與所屬實際業務。"),
    "存託憑證": ("tdr", "存託憑證（TDR／DR）是境外公司在台掛牌的憑證，價格連動原股與匯率，流動性與資訊揭露需特別留意。"),
...
<header class="top-bar">
  <div class="container top-bar-inner">
    ...
    <div class="top-right"><a href="../login">會員登入</a><a href="../register">免費註冊</a><a href="https://line.me/R/ti/p/@130tqckv" class="line-cta" target="_blank" rel="noopener">LINE 客服</a></div>
  </div>
</header>
...
<nav class="main-nav">
  <div class="container">
    <ul>
      <li><a href="/">首頁</a></li>
      <li><a href="../stocks">股價總覽</a></li>
      <li><a href="../industries">產業分類</a></li>
      <li><a href="../risk-radar">防錯雷達</a></li>
      <li><a href="../learn"><svg width="15" height="15" viewBox="0 0 256 256" fill="currentColor" style="vertical-align:-2.5px;margin-right:4px;"><path d="M232,56V200H160a32,32,0,0,0-32,32V88a32,32,0,0,1,32-32Z" fill="#c9a24b" opacity=".9"/><path d="M232,48H160a40,40,0,0,0-32,16A40,40,0,0,0,96,48H24a8,8,0,0,0-8,8V200a8,8,0,0,0,8,8H96a24,24,0,0,1,24,24,8,8,0,0,0,16,0,24,24,0,0,1,24-24h72a8,8,0,0,0,8-8V56A8,8,0,0,0,232,48ZM96,192H32V64H96a24,24,0,0,1,24,24V200A39.81,39.81,0,0,0,96,192Zm128,0H160a39.81,39.81,0,0,0-24,8V88a24,24,0,0,1,24-24h64ZM160,88h40a8,8,0,0,1,0,16H160a8,8,0,0,1,0-16Zm48,40a8,8,0,0,1-8,8H160a8,8,0,0,1,0-16h40A8,8,0,0,1,208,128Zm0,32a8,8,0,0,1-8,8H160a8,8,0,0,1,0-16h40A8,8,0,0,1,208,160Z"/></svg>學習中心</a></li>
      <li><a href="../ai">AI 對話</a></li>
    </ul>
  </div>
</nav>
...
<main class="ind-wrap">
  <div class="article-breadcrumb" style="font-size:13px;color:#888;margin-bottom:10px;">
    <a href="/" style="color:#1B4332;">首頁</a> ▸
    <a href="../industries" style="color:#1B4332;">產業分類</a> ▸
  ...
  <div class="ind-tools">
    <a href="../check"><svg width="15" height="15" viewBox="0 0 256 256" fill="currentColor" style="vertical-align:-2.5px;margin-right:4px;"><path d="M192,112a80,80,0,1,1-80-80A80,80,0,0,1,192,112Z" fill="#c9a24b" opacity=".9"/><path d="M229.66,218.34,179.6,168.28a88.21,88.21,0,1,0-11.32,11.31l50.06,50.07a8,8,0,0,0,11.32-11.32ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z"/></svg>個股買前檢查</a>
    <a href="../risk-radar"><svg width="15" height="15" viewBox="0 0 256 256" fill="currentColor" style="vertical-align:-2.5px;margin-right:4px;"><path d="M216,56v56c0,96-88,120-88,120S40,208,40,112V56a8,8,0,0,1,8-8H208A8,8,0,0,1,216,56Z" fill="#c9a24b" opacity=".9"/><path d="M120,136V96a8,8,0,0,1,16,0v40a8,8,0,0,1-16,0Zm8,48a12,12,0,1,0-12-12A12,12,0,0,0,128,184ZM224,56v56c0,52.72-25.52,84.67-46.93,102.19-23.06,18.86-46,25.27-47,25.53a8,8,0,0,1-4.2,0c-1-.26-23.91-6.67-47-25.53C57.52,196.67,32,164.72,32,112V56A16,16,0,0,1,48,40H208A16,16,0,0,1,224,56Zm-16,0L48,56l0,56c0,37.3,13.82,67.51,41.07,89.81A128.25,128.25,0,0,0,128,223.62a129.3,129.3,0,0,0,39.41-22.2C194.34,179.16,208,149.07,208,112Z"/></svg>防錯雷達</a>
    <a href="../learn/warning-stocks"><svg width="15" height="15" viewBox="0 0 256 256" fill="currentColor" style="vertical-align:-2.5px;margin-right:4px;"><path d="M232,56V200H160a32,32,0,0,0-32,32,32,32,0,0,0-32-32H24V56H96a32,32,0,0,1,32,32,32,32,0,0,1,32-32Z" fill="#c9a24b" opacity=".9"/><path d="M232,48H160a40,40,0,0,0-32,16A40,40,0,0,0,96,48H24a8,8,0,0,0-8,8V200a8,8,0,0,0,8,8H96a24,24,0,0,1,24,24,8,8,0,0,0,16,0,24,24,0,0,1,24-24h72a8,8,0,0,0,8-8V56A8,8,0,0,0,232,48ZM96,192H32V64H96a24,24,0,0,1,24,24V200A39.81,39.81,0,0,0,96,192Zm128,0H160a39.81,39.81,0,0,0-24,8V88a24,24,0,0,1,24-24h64Z"/></svg>注意股是什麼</a>
  </div>

  <h2 style="font-size:19px;color:#1B4332;margin:24px 0 10px;">{escape(cat)}成分股清單</h2>
  <div class="ind-src"><svg width="15" height="15" viewBox="0 0 256 256" fill="currentColor" style="vertical-align:-2.5px;margin-right:4px;"><path d="M216,48V88H40V48a8,8,0,0,1,8-8H208A8,8,0,0,1,216,48Z" fill="#c9a24b" opacity=".9"/><path d="M208,32H184V24a8,8,0,0,0-16,0v8H88V24a8,8,0,0,0-16,0v8H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM72,48v8a8,8,0,0,0,16,0V48h80v8a8,8,0,0,0,16,0V48h24V80H48V48ZM208,208H48V96H208V208Zm-68-76a12,12,0,1,1-12-12A12,12,0,0,1,140,132Zm44,0a12,12,0,1,1-12-12A12,12,0,0,1,184,132ZM96,172a12,12,0,1,1-12-12A12,12,0,0,1,96,172Zm44,0a12,12,0,1,1-12-12A12,12,0,0,1,140,172Zm44,0a12,12,0,1,1-12-12A12,12,0,0,1,184,172Z"/></svg>更新日期：{TODAY}　·　資料來源：TWSE 證交所、TPEx 櫃買中心、MOPS 公開資訊觀測站（風險等級為領富 AI 依公開資料整理）</div>
...
def main():
    ...
    if hub.exists():
        links = "\n".join(
            f'      <a href="industries/{slug}" style="background:#eef7f1;color:#1B4332;'
